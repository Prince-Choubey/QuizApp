...
class QuestionAdapter(
    ...
    var returnScore: QuestionActivity
    ...
    override fun onBindViewHolder(holder: QuestionAdapter.Viewholder, position: Int) {
        ...
        if (differ.currentList.size == 5 && currentPos == position) {
            ...
            val drawable = ContextCompat.getDrawable(binding.root.context, R.drawable.mark)
        ...
        if (differ.currentList.size==5){
            ...
            if (clickedPos==position && clickedPos!=currentPos){
                ...
                val drawable = ContextCompat.getDrawable(binding.root.context, R.drawable.cancel)
                binding.answerTxt.setCompoundDrawablesRelativeWithIntrinsicBounds(
                    null,
                    null,
                    drawable,
